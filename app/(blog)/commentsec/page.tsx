...
const CommentSec = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen ">
      <div className="w-full max-w-lg p-6 bg-gray-100 shadow-xl rounded-lg">
        <h2 className="text-2xl font-extrabold text-center text-black mb-5">Comment </h2>
        ...
        <button
          ...
          className="w-full bg-gray-800 text-white p-3 rounded-md hover:bg-black transition-all"
        >
          Post Comment
        </button>
      </div>
      ...
      <div className="w-full max-w-lg mt-10">
        <h3 className="text-xl font-semibold text-center text-gray-700 mb-4">Comments Section</h3>
